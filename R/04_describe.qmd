...
## Combined plot: Correlation Between Smoker Status and Maternal Characterictics
...
combined_plot1 <- (bp_placental_volume + theme(legend.position = "none") + 
  ...
  theme(
    ...
    plot.title = element_text(size = 10, 
                              ...
                              color = "black"),
    plot.margin = grid::unit(c(0, 0, 0, -1.3), "mm")
  ) +
...
Ved ikke hvad det her plot kan bruges til, emn vi kunne godt lave noget lignende.
