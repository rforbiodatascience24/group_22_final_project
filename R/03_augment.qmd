...
```{r}
merged_data <- read_tsv("../data/02_dat_clean.tsv")
```
...
write_tsv(merged_data,
          file = "../data/03_dat_augment_merged_data.tsv")

# Save the merged log2 fold dataset to a tsv file
write_tsv(merged_log2_fold,
          file = "../data/03_dat_augment_log2_fold.tsv")

# Save the merged clean dataset to a tsv file
write_tsv(merged_clean_aug,
          file = "../data/03_dat_augment_merged_clean_aug.tsv")
