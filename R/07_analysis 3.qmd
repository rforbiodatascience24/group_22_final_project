...
```{r}
merged_data <- read_tsv("../data/03_dat_augment_merged_clean_aug.tsv")
```
...
lr_ilmn_1651278 <- merged_clean_aug_long |>
  ...
  labs(x = "Status",
       y = "Log2 Expr. level",
       title = "Probe_ID: ilmn_1651278_snip1",
...
lr_ilmn_1651375 <- merged_clean_aug_long |>
  ...
  labs(x = "Status",
    y = "Log2 Expr. level",
    title = "Probe_ID: ilmn_1651375_bicd2",
    color = "Smoking Status") +  # Set legend title
  scale_color_manual(values = c("0" = "#F9A1A1", "1" = "#63B8B8"),
                     labels = c("0" = "Non-smoker", "1" = "Smoker"))  # Set legend labels)
...
lr_ilmn_1651767 <- merged_clean_aug_long |>
 ...
 labs(x = "Status",
    y = "Log2 Expr. level",
    title = "Probe_ID: ilmn_1651767_mkl1",
    color = "Smoking Status") +  # Set legend title
  scale_color_manual(values = c("0" = "#F9A1A1", "1" = "#63B8B8"),
                     labels = c("0" = "Non-smoker", "1" = "Smoker"))  # Set legend labels))
