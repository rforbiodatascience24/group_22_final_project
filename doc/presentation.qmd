...
```{r}
#| echo: true
characteristics_data <- read_tsv(here("02_dat_clean_characteristics.tsv.gz"))  # Read and display the gzipped TSV file
...
```{r}
#| echo: true
genes_data <- read_tsv(here("02_dat_clean_genes.tsv.gz"))  # Read and display the gzipped TSV file
...
```{r}
#| echo: true
clean_data <- read_tsv(here("02_dat_clean.tsv.gz"))  # Read and display the gzipped TSV file
